...
class SNAKE:
    ...
    def move(self):
        ...
        if new[0] in range(0, screen_width) and new[1] in range(0,
                screen_width) and not new in self.positions[2:]:
...
class FOOD:
    ...
    def random_position(self):
        self.position = (random.randint(0, grid_width - 1) * gridsize,
                         random.randint(0, grid_height - 1) * gridsize)  # position random
...
def main():
    ...
    while True:
        ...
        score_text = font.render('Score:{0}'.format(snake.score), True,
